  ...
  <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8">
    <div className="relative">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Your Cart</h2>
          <p className="text-gray-400 text-sm sm:text-base">Review and checkout your items</p>
      ...
      {cartItems.length === 0 ? (
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 ${loading ? "opacity-50" : ""} transition-opacity duration-200`}>
              ...
              (item) =>
                item.dish && (
                  <div
                    ...
                    hover:border-purple-500/50 transition-all duration-300 group ${!item.dish.inStock ? "opacity-30 " : ""}`}
                  >
